...
class Test_PublishImage():
    def publishImage(self, username, password, iamge, driver):
    ...
    def setUp(self):
        ...
        self.testcaseinfo = TestCaseInfo(id="4", name="Publish image Successfully", owner="LJL")
    ...
    def test_Login(self):
        ...
        time.sleep(2)
        self.publishImage('213', '321323', r'C:\Users\li\Desktop\win.png', self.driver)
